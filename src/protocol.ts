...
/* Method codes */
export const METHOD_ENTRIES   = 0x01;
export const METHOD_STAT      = 0x02;
export const METHOD_EXISTS    = 0x03;
export const METHOD_READFILE  = 0x04;
...
export class BufReader {
  ...
  u8(): number  { const v = this.buf.readUInt8(this.off);     this.off += 1; return v; }
...
export class BufWriter {
  ...
  u8(v: number): this  { this.ensure(1); this.buf.writeUInt8(v, this.off);     this.off += 1; return this; }
  u16(v: number): this { this.ensure(2); this.buf.writeUInt16LE(v, this.off);  this.off += 2; return this; }
  u32(v: number): this { this.ensure(4); this.buf.writeUInt32LE(v, this.off);  this.off += 4; return this; }
  f64(v: number): this { this.ensure(8); this.buf.writeDoubleLE(v, this.off);  this.off += 8; return this; }
  ...
  build(): Buffer { return this.buf.subarray(0, this.off); }
}
